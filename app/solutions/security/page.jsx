      ...
      <div className='flex flex-col lg:flex-row justify-center items-center gap-6 mt-12 p-24'>
        <div className='bg-neutral-800 p-12 lg:w-1/3'>
            <h1 className='text-4xl my-6 bg-clip-text text-transparent bg-gradient-to-r from-green-700 to-blue-500'>Security Dashboard:</h1>
                ...
                <h2 className='text-2xl my-2 bg-clip-text text-transparent bg-gradient-to-r from-green-700 to-blue-500'>Features:</h2>
        ...
        <div className='flex flex-col gap-4 lg:w-2/3'>
            <Image alt='Psytech Software Core' width={1200} height={1200} src='/dashboardSecurityPreview.jpg' className='rounded-lg w-full opacity-90'></Image>
        </div>        
      </div>
    </div>
  )
